...
Rcpp::NumericMatrix rcpp_get_sp_dists_par_dijkstra(const Rcpp::DataFrame graph, const Rcpp::DataFrame vert_map_in, Rcpp::IntegerVector fromi, Rcpp::IntegerVector toi, const std::string& heap_type);
RcppExport SEXP _dodgr_rcpp_get_sp_dists_par_dijkstra(SEXP graphSEXP, SEXP vert_map_inSEXP, SEXP fromiSEXP, SEXP toiSEXP, SEXP heap_typeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::DataFrame >::type graph(graphSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(rcpp_get_sp_dists_par_dijkstra(graph, vert_map_in, fromi, toi, heap_type));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_get_sp_dists_par_astar
Rcpp::NumericMatrix rcpp_get_sp_dists_par_astar(const Rcpp::DataFrame graph, const Rcpp::DataFrame vert_map_in, Rcpp::IntegerVector fromi, Rcpp::IntegerVector toi, const std::string& heap_type);
RcppExport SEXP _dodgr_rcpp_get_sp_dists_par_astar(SEXP graphSEXP, SEXP vert_map_inSEXP, SEXP fromiSEXP, SEXP toiSEXP, SEXP heap_typeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::DataFrame >::type graph(graphSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type toi(toiSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type heap_type(heap_typeSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_get_sp_dists_par_astar(graph, vert_map_in, fromi, toi, heap_type));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_get_sp_dists
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_dodgr_rcpp_get_sp_dists_par_dijkstra", (DL_FUNC) &_dodgr_rcpp_get_sp_dists_par_dijkstra, 5},
    {"_dodgr_rcpp_get_sp_dists_par_astar", (DL_FUNC) &_dodgr_rcpp_get_sp_dists_par_astar, 5},
